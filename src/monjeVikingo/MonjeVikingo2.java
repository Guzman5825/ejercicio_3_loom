...
public class MonjeVikingo2 {
	...
	public MonjeVikingo2(double vida)		///imaginemos que este es el estado inicial
	{
		this.vida=vida;
		setEstadoNormal(); 
	}
	...
	public void meditar() {
		...
		case CALMADO: 
			break;
		case NORMAL: setEstadoCalmado();
			break;
		case COLERICO: setEstadoNormal();
			break;
		case BERSERKER: setEstadoNormal();
			break;
		default: break;
		}
	}
	...
	public void recibirDaño(double dañoRecibido){
		...
		case CALMADO:
			break;
		case NORMAL: setEstadoColerico();
			break;
		case COLERICO: setEstadoBeserker();
			break;
		case BERSERKER:
			break;
		default: break;
	...
	private String getEstado()
	{
		String est=null;
		switch (estado) {
		case CALMADO: est="Calmado"; 
			break;
		case NORMAL:est="Normal"; 
			break;
		case COLERICO:est="Colerico"; 
			break;
		case BERSERKER: est="Berseker"; 
			break;
		default: break;
		}
		return est;
